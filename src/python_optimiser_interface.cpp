...
extern "C"
{
  ...
  PyObject* _Optimiser_optimise_partition(PyObject *self, PyObject *args, PyObject *keywds)
  {
    ...
    double _c_threshold = -1.0;
    static char* kwlist[] = {"optimiser", "partition", "threshold", NULL};
    #ifdef DEBUG
      cerr << "Parsing arguments..." << endl;
    #endif

    if (!PyArg_ParseTupleAndKeywords(args, keywds, "OO|d", kwlist,
                                     &py_optimiser, &py_partition, &_c_threshold))
        return NULL;
    ...
    double q = 0.0;
    optimiser->threshold = _c_threshold;
    try
    {
