...
def find_partition(graph, partition_type, threshold, comm_select=1, initial_membership=None, weights=None, seed=None, **kwargs):
  ...
  **kwargs
  ...
  print("COMM SELECT METHOD SET!")
  if (not seed is None):
    optimiser.set_rng_seed(seed)

  optimiser.optimise_partition(partition, threshold)
  return partition
